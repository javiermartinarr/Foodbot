        ...
        <div className="space-y-4">
          {top5.map((restaurante, index) => (
            ...
            >
              ...
              <div className="bg-gray-900 dark:bg-dark-elevated text-white dark:text-dark-text px-3 py-1.5 rounded-xl text-sm font-semibold border border-gray-700 dark:border-dark-border">
